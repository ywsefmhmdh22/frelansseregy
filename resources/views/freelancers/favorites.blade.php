            ...
            <div class="col-lg-9">
                ...
                <div class="top-header-bar d-flex justify-content-between align-items-center mb-4 p-4 glass-card bg-gradient-fav text-white">
                    ...
                    <div class="d-none d-md-block">
                        <i class="fas fa-users-beam fs-1 opacity-25"></i>
                    </div>
                </div>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-4">
                        <div class="glass-card freelancer-card p-4 text-center border-0 position-relative overflow-hidden">
                            ...
                            <form action="{{ route('favorites.toggle') }}" method="POST">
                                ...
                                <button type="submit" class="remove-fav-btn" title="حذف من المفضلين">
                            ...
                            <div class="freelancer-avatar-wrapper mb-3 mx-auto">
                                <img src="{{ $freelancer->profile_image ? asset('storage/'.$freelancer->profile_image) : 'https://ui-avatars.com/api/?name='.urlencode($freelancer->name).'&background=10b981&color=fff' }}"
                                     class="rounded-circle border border-4 border-white shadow-sm" width="90" height="90">
                                @if($freelancer->isOnline()) <!-- افتراض وجود ميثود للتحقق من الاتصال -->
                            ...
                            <div class="d-flex justify-content-center gap-2 mb-3">
                                <span class="badge bg-soft-warning text-warning rounded-pill px-2">
                                    <i class="fas fa-star me-1"></i> {{ number_format($freelancer->rating ?? 5.0, 1) }}
                                </span>
                                <span class="badge bg-soft-primary text-primary rounded-pill px-2">
                                    <i class="fas fa-check-circle me-1"></i> {{ $freelancer->completed_projects_count ?? 0 }} مشروع
                                </span>
                            </div>
                    ...
                    <div class="col-12 text-center py-5 glass-card">
                        <img src="https://illustrations.popsy.co/flat/taking-notes.svg" width="200" class="mb-4">
